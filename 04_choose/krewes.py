...
* The main function first selects a random period/key and then returns a random devo/value from that period/key
'''
...
def get_devo(krewes):
    ...
    return classlist[random.randrange(len(classlist))]
