...
var clicky = function(e) {
  ...
  // only one function call to clicky will be made
  //e.stopPropagation();
};
...
//yes it does, the later eventListeners are called first

//Predict, then test...
//Q: What effect does the boolean arg have in each?
//   (Leave exactly 1 version uncommented to test...)
//The boolean arg gives precedence to the function call with respect to the instance variable
